...
Contact: Yinghao Cao <yhcao@ibms.pumc.edu.cn>
	...
	designparser.add_argument('--minlength',default=20,help="Primer minimum length. [Default:%(default)s]")
	designparser.add_argument('--maxlength',default=25,help="Primer maximum length. [Default:%(default)s]")
	designparser.add_argument('--mintm',default=50,help="Primer minimum TM. [Default:%(default)s]")
	designparser.add_argument('--maxtm',default=60,help="Primer maximum TM. [Default:%(default)s]")
	designparser.add_argument('-m','--maxnum',default=3,help="Maximum primer pairs for one CpG island. [Default:%(default)s]")
	designparser.add_argument('--tmdiff',default=5,help="Maximum TM difference in primer pairs. [Default:%(default)s]")
	...
	searchparser.add_argument('-c','--mismatch',default=3,help="Maximum mismatch in one primer sequence, (<=3). [Default:%(default)s]")
